...
@FeignClient(name = "dubbo-rest-service", 
            url = "http://${server.host}:20880/users",
            configuration = org.apache.dubbo.benchmark.config.OkHttpConfig.class)
public interface DubboRestUserServiceFeignClient {
